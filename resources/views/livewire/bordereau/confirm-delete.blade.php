<div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" wire:click="deleteBordereau">Supprimer</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <button type="button" class="btn btn-danger" wire:click="$emit('confirmDelete')">Supprimer</button>
